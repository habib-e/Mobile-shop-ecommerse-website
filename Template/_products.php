        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <hr>
                    <p class="font-rale font-size-14">Price : 80,100.00 BDT
                        Brand : Samsung
                        Model No : Galaxy S6 edge
                        Short Description : Samsung Galaxy S6 edge,
                        Price: 80,100.00 Tk,
                        Os: Android OS, v5.0.2 (Lollipop),
                        Memory: 32/64/128 GB, 3 GB RAM,
                        3G: Yes,
                        Camera: 16 MP,(2988 x 5312) pixels,
                        ...
                        Type: Super AMOLED capacitive touchscreen, 16M colors</p>
                </div>
            </div>
        </div>
    </section>
